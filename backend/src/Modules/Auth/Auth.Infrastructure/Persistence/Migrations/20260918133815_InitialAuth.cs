    ...
    public partial class InitialAuth : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LKP_BRANCH", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    NameAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CbuCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrgScopes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionIndex = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ExpiresAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SsoAuthorizationCodes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceUuid = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    LastActiveLatitude = table.Column<double>(type: "float", nullable: true),
                    LastActiveLongitude = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LKP_OPERATION_AREA_Code",
                schema: "Auth",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrgScopes_OwnerType_OwnerId",
                schema: "Auth",
                table: "OrgScopes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SsoAuthorizationCodes_CodeHash",
                schema: "Auth",
                table: "SsoAuthorizationCodes",
                column: "CodeHash");

            migrationBuilder.CreateIndex(
                name: "IX_SsoAuthorizationCodes_UserId",
                schema: "Auth",
                table: "SsoAuthorizationCodes",
                column: "UserId");
